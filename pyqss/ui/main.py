...
class Ui_QssWindow(object):
    def setupUi(self, QssWindow):
        ...
        self.btn_format = QtWidgets.QPushButton(self.widget_top)
        self.btn_format.setMouseTracking(True)
        self.btn_format.setObjectName("btn_format")
        self.horizontalLayout.addWidget(self.btn_format)
        self.btn_default = QtWidgets.QPushButton(self.widget_top)
        self.btn_default.setMouseTracking(True)
    ...
    def retranslateUi(self, QssWindow):
        ...
        self.btn_format.setText(_translate("QssWindow", "format"))
        self.btn_default.setText(_translate("QssWindow", "default"))
        self.label_title.setText(_translate("QssWindow", "JSON Editor"))
