...
if __name__ == '__main__':
    ...
    kafka_conf = {
        ...
        'group.id': 'my-test_group-888',  # 消费者组 ID
    ...
    # 获取指定时间戳对应的 offset
    start_time = int(datetime(2025, 3, 14, 0, 0, 0).timestamp() * 1000)  # 开始时间戳，毫秒级
    end_time = int(datetime(2025, 3, 14, 23, 59, 59).timestamp() * 1000)  # 结束时间戳，毫秒级
    #print(start_time)
    # 查询 offset
