...
try:
    ...
    d = os.path.dirname(__file__) + "/log/"
    # print(d)
    ...
    # logFilePath = QgsApplication.qgisSettingsDirPath() + "log/qgis_openlr.log"
    logFilePath = d + "qgis_openlr.log"
    # print(logFilePath)

class log(object):

    handler = None
    pluginId = "openlrtools"
    ...
    def initLogging():
        ...
        try:
            ...
            log.handler = logging.handlers.RotatingFileHandler(
                logFilePath, maxBytes=1024 * 1024 * 10
            )
