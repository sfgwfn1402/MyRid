...
DEFAULT_FOW_STAND_IN_SCORE = [
    [0.50, 0.50, 0.50, 0.50, 0.50, 0.50, 0.50, 0.50],  # Undefined FOW
    [0.50, 1.00, 0.80, 0.60, 0.40, 0.20, 0.00, 0.00],  # Motorway
    [0.50, 0.60, 1.00, 0.80, 0.60, 0.40, 0.20, 0.00],  # Multiple carriage way
    [0.50, 0.40, 0.80, 1.00, 0.80, 0.60, 0.40, 0.20],  # Single carriage way
    [0.50, 0.20, 0.40, 0.80, 1.00, 0.80, 0.60, 0.40],  # Roundabout
    [0.50, 0.00, 0.20, 0.40, 0.60, 1.00, 0.80, 0.60],  # Traffic quare
    [0.50, 0.00, 0.00, 0.20, 0.40, 0.60, 1.00, 0.80],  # Sliproad
    [0.50, 0.00, 0.00, 0.20, 0.40, 0.40, 0.60, 1.00],  # Other FOW
]
